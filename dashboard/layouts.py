            ...
            dbc.Row(
                [
                    dbc.Col(
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody(id="overview-status-indicators"),
                            ],
                            color="light",
                        ),
                        width=3,
                    ...
                    dbc.Col(
                        dbc.Card(
                            [
                                dbc.CardHeader("Total Value"),
                                dbc.CardBody(id="overview-total-value"),
                            ],
                            color="light",
                        ),
                        width=3,
                    ...
                    dbc.Col(
                        dbc.Card(
                            [dbc.CardHeader("Cash"), dbc.CardBody(id="overview-cash")],
                            color="light",
                        ),
                        width=3,
                    ),
                    dbc.Col(
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody(id="overview-open-positions"),
                            ],
                            color="light",
                        ),
                        width=3,
            ...
            dbc.Row(
                [
                    dbc.Col(
                        dbc.Card(
                            [
                                dbc.CardHeader("System Alerts / Disabled Symbols"),
                                dbc.CardBody(id="overview-alerts"),
                            ]
                        ),
                        width=12,
                    ),
...
def create_market_view_layout() -> dbc.Container:
    ...
    try:
        initial_symbol_options = [
            {"label": s, "value": s} for s in data_provider.get_target_symbols_list()
        ]
        ...
        [
                ...
                [
                    dbc.Col(
                        dcc.Dropdown(
                            ...
                            value=(
                                initial_symbol_options[0]["value"]
                                if initial_symbol_options
                                else None
            ...
            dbc.Row(
                [
                    dbc.Col(
                        dcc.Graph(
                            id="market-price-chart",
                            figure=create_empty_figure("Select symbol to load chart"),
                        )
                    ),
                ]
            ),
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        html.Div(
                            id="market-news-feed", children="News feed placeholder..."
                        ),
                        width=12,
                    ),
                ],
        ...
        [
            ...
            dbc.Row(
                [
                    dbc.Col(
                        dcc.Graph(
                            id="sentiment-agg-chart", figure=create_empty_figure()
                        )
                    ),
                ]
            ),
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        html.Div(
                            id="sentiment-feed",
                            children="Sentiment feed placeholder...",
                        ),
                        width=12,
                    ),
                ],
...
def create_trading_layout() -> dbc.Container:
    ...
    return dbc.Container(
        [
            dbc.Row([dbc.Col(html.H4("Open Positions"), width=12)], className="mb-2"),
            dbc.Row(
                [
                    dbc.Col(
                        dash_table.DataTable(
            ...
            dbc.Row([dbc.Col(html.H4("Trade History"), width=12)], className="mb-2"),
            dbc.Row(
                [
                    dbc.Col(
                        dash_table.DataTable(
        ...
        [
            ...
            dbc.Row(
                [
                    dbc.Col(
                        dbc.Switch(
                            id="settings-trading-mode-switch",
                    ...
                    dbc.Col(
                        html.Div(
                            id="settings-trading-mode-status",
                            children="Current Mode: PAPER",
                        ),
                        width=6,
                    ),
                ],
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.Button(
                            "Update",
                            id="settings-update-capital-pct-button",
                            color="primary",
                            size="sm",
                        ),
                        width=2,
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.Input(
                            id="settings-stop-loss-input",
                            type="number",
                            value=initial_settings.get("stop_loss_pct", 0.05),
                            min=0.001,
                            max=0.5,
                            step=0.001,
                        ),
                    ...
                    dbc.Col(
                        dbc.Button(
                            "Update",
                            id="settings-update-stop-loss-button",
                            color="primary",
                            size="sm",
                        ),
                        width=2,
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.Input(
                            id="settings-take-profit-input",
                            type="number",
                            value=initial_settings.get("take_profit_pct", 0.10),
                            min=0.001,
                            max=1.0,
                            step=0.001,
                        ),
                    ...
                    dbc.Col(
                        dbc.Button(
                            "Update",
                            id="settings-update-take-profit-button",
                            color="primary",
                            size="sm",
                        ),
                        width=2,
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.Input(
                            id="settings-drawdown-input",
                            type="number",
                            value=initial_settings.get("portfolio_drawdown_pct", 0.15),
                            min=0.01,
                            max=0.9,
                            step=0.01,
                        ),
                    ...
                    dbc.Col(
                        dbc.Button(
                            "Update",
                            id="settings-update-drawdown-button",
                            color="primary",
                            size="sm",
                        ),
                        width=2,
            ...
            dbc.Row(
                [dbc.Col(html.H4("Disabled Symbols Management"), width=12)],
                className="mb-2",
            ),
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dcc.Dropdown(
                            id="settings-disabled-symbol-dropdown",
                            options=[],
                            placeholder="Select symbol...",
                        ),
                        width=4,
                    ...
                    dbc.Col(
                        dbc.Button(
                            "Re-enable Symbol",
                            id="settings-reenable-symbol-button",
                            color="warning",
                            size="sm",
                        ),
                        width=2,
...
def create_main_layout() -> html.Div:
    ...
    return html.Div(
        [
            dbc.NavbarSimple(
                brand="Cyclone v2 Trading Bot Dashboard",
                color="dark",
                dark=True,
                fluid=True,
            ),
            dbc.Tabs(
                ...
                children=[
                    ...
                    dbc.Tab(
                        label="Market View",
                        tab_id="tab-market",
                        children=create_market_view_layout(),
                    ),
                    dbc.Tab(
                        label="Sentiment",
                        tab_id="tab-sentiment",
                        children=create_sentiment_layout(),
                    ),
                    dbc.Tab(
                        label="Trading Monitor",
                        tab_id="tab-trading",
                        children=create_trading_layout(),
                    ),
