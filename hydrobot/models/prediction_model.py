...
class PredictionModel:
    ...
    def _initialize_model(self) -> None:
        ...
        try:
            ...
            logger.error("model_init_error", error=str(e))
    ...
    def _train_new_model(self) -> None:
        ...
        try:
            ...
            logger.info("model_trained", params=params)
        ...
        try:
            ...
            for col in self.feature_columns:
                if col not in features:
                    logger.warning("missing_feature", feature=col)
                    return None
            ...
            # Track prediction
            self._predictions.append((datetime.utcnow(), prob))

            return prob

        except Exception as e:
            logger.error("prediction_error", error=str(e), features=features)
            return None
    ...
    def update_accuracy(self, actual_movement: float) -> None:
        ...
        try:
            ...
            logger.error("accuracy_update_error", error=str(e))
